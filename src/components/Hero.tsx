...
export default function Hero() {
	return (
		<section className='relative overflow-hidden bg-slate-950 text-white'>
			...
			<div className='bg-grid-pattern mask-radial-fade absolute inset-0 opacity-60' />
			<div className='relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-16 px-6 py-20 md:flex-row md:items-stretch lg:px-10'>
				<div className='flex w-full flex-col justify-center space-y-8 md:max-w-xl'>
					<span className='inline-flex w-fit items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1 text-xs tracking-[0.3em] text-white/70 uppercase'>
						Pokédex 2.0
					</span>
					...
					<p className='text-base text-white/70 sm:text-lg'>
						Search hundreds of Pokémon with official artwork, detailed stats, and effortless
						favoriting. Built for speed, powered by PokéAPI.
					</p>
					...
					<dl className='grid grid-cols-2 gap-6 pt-8 text-white/60 sm:grid-cols-3'>
						<div>
							<dt className='text-xs tracking-wide uppercase'>Pokémon Indexed</dt>
							<dd className='text-2xl font-semibold text-white'>900+</dd>
						</div>
						<div>
							<dt className='text-xs tracking-wide uppercase'>Favorite Sync</dt>
							<dd className='text-2xl font-semibold text-white'>Offline ready</dd>
						</div>
						<div>
							<dt className='text-xs tracking-wide uppercase'>Live data</dt>
				...
				<div className='relative mx-auto flex w-full max-w-sm flex-1 justify-center md:max-w-lg'>
					<div className='absolute inset-0 -translate-x-1/3 opacity-40 blur-3xl sm:-translate-x-1/4'>
						<div className='h-full w-full rounded-full bg-purple-500/40' />
					</div>
					<div className='relative overflow-hidden rounded-[2.5rem] border border-white/15 bg-white/10 px-10 pt-16 pb-10 shadow-[0_40px_80px_-50px_rgba(59,130,246,0.8)] backdrop-blur-xl'>
						...
						<div className='relative flex h-full flex-col items-center justify-between'>
							...
							<div className='mt-10 w-full rounded-2xl border border-white/10 bg-white/5 p-5 text-sm text-white/80 backdrop-blur'>
								...
								<p className='mt-2 text-xs tracking-[0.3em] uppercase'>{FEATURED_POKEMON.type}</p>
								<p className='mt-4 text-xs text-white/60'>
									A flying inferno with a fierce competitive spirit and one of the most beloved
