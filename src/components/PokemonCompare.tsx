									...
									<div className="flex items-center gap-4">
										<div className="flex flex-1 items-center gap-2">
											<span className={cn(
												...
												comparison === 'higher' ? 'text-green-400' : comparison === 'lower' ? 'text-red-400' : 'text-white'
											)}>
												{stat1}
											</span>
											<div className="relative h-4 flex-1 overflow-hidden rounded-full bg-white/10">
												<div
													className={cn(
														...
														comparison === 'higher' ? 'bg-green-500' : comparison === 'lower' ? 'bg-red-500/50' : 'bg-blue-500'
													)}
										...
										<div className="flex flex-1 items-center gap-2">
											<div className="relative h-4 flex-1 overflow-hidden rounded-full bg-white/10">
												<div
													className={cn(
														'h-full rounded-full transition-all duration-500',
														comparison === 'lower' ? 'bg-green-500' : comparison === 'higher' ? 'bg-red-500/50' : 'bg-blue-500'
													)}
											...
											<span className={cn(
												'w-12 font-semibold',
												comparison === 'lower' ? 'text-green-400' : comparison === 'higher' ? 'text-red-400' : 'text-white'
											)}>
												{stat2}
											</span>
										</div>
