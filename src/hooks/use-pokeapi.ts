...
const pokemonQueryKeys = {
	...
	listPage: (limit: number, offset: number) => [...pokemonQueryKeys.list, limit, offset] as const,
...
export const useGetPokemonTypes = (
	...
	useQuery<PokemonData, Error, PokemonData['types'], PokemonDetailQueryKey>({
		queryKey: pokemonQueryKeys.detail(pokemonName),
		queryFn: () => getPokemon(pokemonName),
...
export const useGetAllPokemon = (): UseQueryResult<NamedAPIResource[], Error> =>
	useQuery<NamedAPIResource[], Error, NamedAPIResource[], PokemonListQueryKey>({
...
export const useGetAllPokemonPage = (
	...
	useQuery<NamedAPIResource[], Error, NamedAPIResource[], PokemonListPageQueryKey>({
